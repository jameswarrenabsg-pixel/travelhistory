...
export const YearSelector: React.FC<YearSelectorProps> = ({
  ...
  const defaultYears = Array.from({ length: 11 }, (_, i) => 2026 - i);
  // Merge custom years if available in dataset
  const allYears = Array.from(new Set([...defaultYears, ...availableYears])).sort((a, b) => b - a);
